...
public Articulo findArticuloByName(String nombre) {
    EntityManager em = getEntityManager();
    try {
        TypedQuery<Articulo> query = em.createQuery("SELECT a FROM Articulo a WHERE a.nombre = :nombre", Articulo.class);
